...
%Garman-Kolhagen Model Calib
x0=0.2; %initial Volatiliy
...
%Building the Gram-Charlier Model
...
%Fitting the Garman-Kohlhagen Model parameters 
global  Pgk data x
if(x<=0)
   L=realmax;
else
...
%% Function to estimate the parameter of the Gram-Charlier Model
